...
class camera {
    public: 
        ...
        double vfov = 90;                   //Vertival view angle
        point3 lookfrom = point3(0,0,-1);   //point camera is looking from
        point3 lookat = point3(0,0,0);      //point camera is looking at
        vec3 vup = vec3(0,1,0);             //Camera-relitve up direction

        double defocus_angle = 0;           // Variation angle of rays through each pixel
        double focus_dist = 10;            //Disatnce from camera lookfrom point to plane of perfect focus
    ...
    private:
        ...
        void initialize(){
            //Calculate image height, minimum 1
        ...
        color ray_color(const ray& r, int depth, const hittable& world) const {
            ...
            return ((1.0-a)*color(1.0, 1.0, 1.0) + a*color(0.5, 0.7, 1.0)); //blended value
        }
